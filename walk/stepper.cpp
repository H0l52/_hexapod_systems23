/*
 * Stepper.h - Stepper library for Wiring/Arduino - Unofficial - Version 1.1.1
 *
 ...
 * Multiple step fix       (1.1.1) by Dylan Holmes
 *
...
/* 
 * Moves the motor partial steps_to_move steps.
 *
 */
void Stepper::updateMotor() {
 ...
 * the motor moves in the reverse direction.
 */
void Stepper::forceStep(int steps_to_move)
{
  this->steps_left = abs(steps_to_move);  // how many steps to take
